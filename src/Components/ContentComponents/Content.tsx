 ...
 let openWindow = (ad:ContentType) => {
  ...
  return(// refactoring item title
    <div className={s.wrapper}>
      <div>{isOpen && <ItemWindow changeWindow={changeWindow} itemData={currentAd}/>}</div>
      ...
      <div>{isLoading ? <div>vvfvffv</div>: <div className={s.items}>{array.map((item,index) => {return <div key={item.id} className={s.itemWrapper} onClick={() => openWindow(item)}>
