      ...
      <div className={s.wrapper}>
        ...
        <div className={s.content}>
          <div className={s.header}>
            <div className={s.top}>
              <p className={s.date}>{itemData.date}</p>
              <svg width="24" height="24" onClick={()=>changeWindow()} viewBox="0 0 24 24" fill="#032f72" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className={s.title}>{itemData.title}</p>
            <p className={s.price}>{itemData.price}₽</p>
            <div>
